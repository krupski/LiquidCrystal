...
class LiquidCrystal : public Print {
	public:
		...
		// serial, with reset
		LiquidCrystal (uint8_t, uint8_t, uint8_t, uint8_t); // 4
		// 4 bit parallel, no r/w
		LiquidCrystal (uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t); // 6
		// 4 bit parallel, with r/w, w/o reset
		LiquidCrystal (uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t); // 7
		// 4 bit parallel, with r/w, with reset
		LiquidCrystal (uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t); // 8
		// 8 bit parallel, no r/w
		LiquidCrystal (uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t); // 10
		// 8 bit parallel, with r/w, w/o reset
		LiquidCrystal (uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t); // 11
		// 8 bit parallel, with r/w, with reset
		LiquidCrystal (uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t, uint8_t); // 12
	...
	private:
		...
		#define _MSEC        (1e3)  // divider for builtin delay milliseconds
		#define _USEC        (1e6)  // divider for builtin delay microseconds
		#define _NSEC        (1e9)  // divider for builtin delay nanoseconds
